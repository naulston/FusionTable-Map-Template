...
var MapsLib = {
  ...
  fusionTableId:      "116pVDDp9lZLoNnhsWDJMaF_YvyDYajrvl0ICbaiD",

  //*New Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyCkdd1b9fVqDFYYh0Qtg1n1NJsuX_fKafw",
  ...
  map_centroid:       new google.maps.LatLng(37.801653, -122.258295), //center that your map defaults to
  ...
  doSearch: function(location) {
    ...
    var tempWhereClause = [];
    if ( $("#cbType1").is(':checked')) tempWhereClause.push("Yes");
    if ( $("#cbType2").is(':checked')) tempWhereClause.push("No");
